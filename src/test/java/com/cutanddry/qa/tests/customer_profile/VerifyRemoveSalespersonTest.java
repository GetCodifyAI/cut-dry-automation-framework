...
public class VerifyRemoveSalespersonTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-660")
    public void VerifyRemoveSalesperson() throws InterruptedException {
        ...
        softAssert.assertTrue(Customer.isAddedSalespersonNameDeleted(), "action failed");
