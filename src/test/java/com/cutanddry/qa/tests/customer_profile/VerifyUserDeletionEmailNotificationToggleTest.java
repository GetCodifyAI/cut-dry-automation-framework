...
public class VerifyUserDeletionEmailNotificationToggleTest extends TestBase {
    static User user;
    String CustomerCode = CustomerProfileData.CUSTOMER_CODE1;
    ...
    @Test(groups = "DOT-TC-154")
    public void VerifyUserDeletionEmailNotificationToggle() throws InterruptedException {
        ...
        InternalTools.clickUserDeletionEmailNotificationsToggle(true);
        InternalTools.clickNotificationSave();
        ...
        InternalTools.navigateToConfigureSupplier();
        InternalTools.navigateToIndependentCompEditDetails();
        InternalTools.clickUserDeletionEmailNotificationsToggle(false);
        InternalTools.clickNotificationSave();
