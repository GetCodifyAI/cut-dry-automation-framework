...
public class VerifySubstituteItemFor1OrMoreItemsWithoutSubstitutingTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-216")
    public void verifySubstituteItemFor1OrMoreItemsWithoutSubstituting() throws InterruptedException {
        String itemName;
