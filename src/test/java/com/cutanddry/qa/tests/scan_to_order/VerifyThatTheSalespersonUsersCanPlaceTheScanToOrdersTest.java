...
public class VerifyThatTheSalespersonUsersCanPlaceTheScanToOrdersTest extends TestBase {
    static User user;
    static String featureName = "scan_to_order";
    static String userSP = "apptesters@test.com";
    ...
    @Test(groups = "DOT-TC-1144")
    public static void VerifyThatTheSalespersonUsersCanPlaceTheScanToOrders() throws InterruptedException {
        ...
        Login.navigateToLoginAsPortal(userSP);
