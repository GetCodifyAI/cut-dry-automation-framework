...
public class VerifyPurchaseHistoryWithMarginInOrderGuideAndPDPWhenDisplayMarginToggleEnableTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-1341")
    public void VerifyPurchaseHistoryWithMarginInOrderGuideAndPDPWhenDisplayMarginToggleEnable() throws InterruptedException {
