...
public class VerifyPurchaseHistoryWithPriceInOrderGuideAndPDPWhenDisplayPurchasePriceToggleEnableTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-1345")
    public void VerifyPurchaseHistoryWithPriceInOrderGuideAndPDPWhenDisplayPurchasePriceToggleEnable() throws InterruptedException {
        ...
        softAssert.assertTrue(Catalog.isLastOrderPriceDisplay(String.valueOf(itemPriceUOM1)),"PDP last order price not display");
        softAssert.assertTrue(Catalog.isLastOrderPriceDisplay(String.valueOf(itemPriceUOM2)),"PDP last order price not display");
        Customer.clickClose();
