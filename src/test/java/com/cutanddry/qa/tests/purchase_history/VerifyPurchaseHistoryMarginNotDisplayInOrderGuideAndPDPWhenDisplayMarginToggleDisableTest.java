...
public class VerifyPurchaseHistoryMarginNotDisplayInOrderGuideAndPDPWhenDisplayMarginToggleDisableTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-1342")
    public void VerifyPurchaseHistoryMarginNotDisplayInOrderGuideAndPDPWhenDisplayMarginToggleDisable() throws InterruptedException {
        ...
        softAssert.assertFalse(Catalog.isMarginColumnDisplay(marginColumn),"Margin column not display");
        Customer.clickClose();
