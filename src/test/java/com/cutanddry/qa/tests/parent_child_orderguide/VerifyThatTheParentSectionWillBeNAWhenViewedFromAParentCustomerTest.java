...
public class VerifyThatTheParentSectionWillBeNAWhenViewedFromAParentCustomerTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-1214")
    public void VerifyThatTheParentSectionWillBeNAWhenViewedFromAParentCustomer() throws InterruptedException {
        ...
        for (String childAccount : childAccounts) {
            softAssert.assertTrue(Customer.isChildAccountDisplayed(childAccount),"child account not displayed");
        }
