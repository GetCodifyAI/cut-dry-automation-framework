...
public class VerifyThatNewlyAddedOGInParentAccountListedInChildListPopUpTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-1216")
    public void VerifyThatNewlyAddedOGInParentAccountListedInChildListPopUp() throws InterruptedException {
