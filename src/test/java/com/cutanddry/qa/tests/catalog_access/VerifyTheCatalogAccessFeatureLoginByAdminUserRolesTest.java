...
public class VerifyTheCatalogAccessFeatureLoginByAdminUserRolesTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-1336")
    public void VerifyTheCatalogAccessFeatureLoginByAdminUserRoles() throws InterruptedException {
