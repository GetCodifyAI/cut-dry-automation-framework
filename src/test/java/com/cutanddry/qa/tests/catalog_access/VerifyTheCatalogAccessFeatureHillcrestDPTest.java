...
public class VerifyTheCatalogAccessFeatureHillcrestDPTest extends TestBase {
    static User user;
    String DistributorName = CustomerData.DISTRIBUTOR_HILL_CREST;;
    static String customerId = CustomerData.CUSTOMER_CODE5;;
    ...
    @Test(groups = "DOT-TC-1337")
    public void VerifyTheCatalogAccessFeatureHillcrestDP() throws InterruptedException {
