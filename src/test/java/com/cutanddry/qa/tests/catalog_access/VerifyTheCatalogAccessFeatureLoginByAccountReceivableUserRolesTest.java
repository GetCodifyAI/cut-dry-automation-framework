...
public class VerifyTheCatalogAccessFeatureLoginByAccountReceivableUserRolesTest extends TestBase {
    static User user;
    String DistributorName = CustomerData.DISTRIBUTOR_NAME_IFC_ACCOUNT_RECEIVABLE;;
    ...
    @Test(groups = "DOT-TC-1445")
    public void VerifyTheCatalogAccessFeatureLoginByAccountReceivableUserRoles() throws InterruptedException {
        ...
        softAssert.assertTrue(Customer.isEditCatalogAccessDisplay(),"edit catalog access not display");
