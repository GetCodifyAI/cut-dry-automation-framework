...
public class VerifyTheTrackNotificationsSMSTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-532")
    public void VerifyTheTrackNotificationsSMS() throws InterruptedException {
        ...
        Track.clickOnSMS();
        softAssert.assertTrue(Track.isSMSTemplateAndPreviewDisplayed(),"sms notif error");
