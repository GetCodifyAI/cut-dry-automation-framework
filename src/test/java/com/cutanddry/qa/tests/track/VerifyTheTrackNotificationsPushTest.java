...
public class VerifyTheTrackNotificationsPushTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-535")
    public void VerifyTheTrackNotificationsPush() throws InterruptedException {
