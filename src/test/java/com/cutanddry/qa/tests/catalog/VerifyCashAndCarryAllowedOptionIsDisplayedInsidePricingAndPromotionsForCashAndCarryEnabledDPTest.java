...
public class VerifyCashAndCarryAllowedOptionIsDisplayedInsidePricingAndPromotionsForCashAndCarryEnabledDPTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-1307")
    public void VerifyCashAndCarryAllowedOptionIsDisplayedInsidePricingAndPromotionsForCashAndCarryEnabledDP() throws InterruptedException {
        ...
        softAssert.assertTrue(Catalog.isCashAndCarryAllowedDisplay(cashAndCarryAllowedOption),"Cash and carry Allowed option is not displayed");
