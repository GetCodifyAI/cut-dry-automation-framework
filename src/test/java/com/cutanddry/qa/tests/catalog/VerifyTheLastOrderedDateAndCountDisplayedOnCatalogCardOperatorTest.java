...
public class VerifyTheLastOrderedDateAndCountDisplayedOnCatalogCardOperatorTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-721")
    public void VerifyTheLastOrderedDateAndCountDisplayedOnCatalogCardOperator() throws InterruptedException {
        ...
        softAssert.assertTrue(Catalog.isLastOrderDateDisplayed(expectedDate),"last order not correct");
