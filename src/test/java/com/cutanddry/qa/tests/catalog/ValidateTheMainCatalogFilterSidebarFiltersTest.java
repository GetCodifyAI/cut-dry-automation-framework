...
public class ValidateTheMainCatalogFilterSidebarFiltersTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-758")
    public void ValidateTheMainCatalogFilterSidebarFilters() throws InterruptedException {
