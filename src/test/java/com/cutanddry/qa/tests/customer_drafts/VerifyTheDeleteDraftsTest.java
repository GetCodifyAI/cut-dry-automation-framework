...
public class VerifyTheDeleteDraftsTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-435")
    public void VerifyTheDeleteDrafts() throws InterruptedException {
