...
public class VerifyTheDistributorCanHaveDeliveryAsTheFulfillmentTypeDraftOderSubmissionTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-1226")
    public void VerifyTheDistributorCanHaveDeliveryAsTheFulfillmentTypeDraftOderSubmission() throws InterruptedException {
        ...
        softAssert.assertTrue(Draft.isLastDraftStatusDisplayed(String.valueOf(totalItemPriceReviewOrder),delivery),"fulfilment tag should be not displayed as delivery");
