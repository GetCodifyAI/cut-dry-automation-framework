...
public class VerifyTheDistributorCanHaveMailDeliveryAsTheFulfillmentTypeTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-1225")
    public void VerifyTheDistributorCanHaveMailDeliveryAsTheFulfillmentType() throws InterruptedException {
