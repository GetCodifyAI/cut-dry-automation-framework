...
public class VerifyTheDistributorCanHaveMailDeliveryAsTheFulfillmentTypeDraftOrderSubmissionTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-1228")
    public void VerifyTheDistributorCanHaveMailDeliveryAsTheFulfillmentTypeDraftOrderSubmission() throws InterruptedException {
        ...
        softAssert.assertTrue(Draft.isLastDraftStatusDisplayed(String.valueOf(totalItemPriceReviewOrder),mailDelivery),"fulfilment tag should be not displayed as delivery");
