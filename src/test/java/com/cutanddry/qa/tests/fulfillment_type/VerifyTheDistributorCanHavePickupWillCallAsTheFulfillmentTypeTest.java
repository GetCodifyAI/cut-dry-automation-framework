...
public class VerifyTheDistributorCanHavePickupWillCallAsTheFulfillmentTypeTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-1224")
    public void VerifyTheDistributorCanHavePickupWillCallAsTheFulfillmentType() throws InterruptedException {
