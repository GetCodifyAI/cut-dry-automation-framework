...
public class VerifyTheDistributorCanHaveDeliveryAsTheFulfillmentTypeTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-466")
    public void VerifyTheDistributorCanHaveDeliveryAsTheFulfillmentType() throws InterruptedException {
