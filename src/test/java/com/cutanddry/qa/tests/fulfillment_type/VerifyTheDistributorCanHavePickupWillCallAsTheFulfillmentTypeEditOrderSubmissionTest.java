...
public class VerifyTheDistributorCanHavePickupWillCallAsTheFulfillmentTypeEditOrderSubmissionTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-1230")
    public void VerifyTheDistributorCanHavePickupWillCallAsTheFulfillmentTypeEditOrderSubmission() throws InterruptedException {
        ...
        softAssert.assertTrue(Customer.isFulfilmentTagDisplayed(orderId,pickUp),"The expected fulfillment type is not selected.");
