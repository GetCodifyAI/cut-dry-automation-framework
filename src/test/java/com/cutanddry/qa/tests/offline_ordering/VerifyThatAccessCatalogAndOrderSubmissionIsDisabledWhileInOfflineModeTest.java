...
public class VerifyThatAccessCatalogAndOrderSubmissionIsDisabledWhileInOfflineModeTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-1247")
    public void VerifyThatAccessCatalogAndOrderSubmissionIsDisabledWhileInOfflineMode() throws InterruptedException {
        ...
        Customer.clickOrderGuideProduct(itemName);
        softAssert.assertFalse(Customer.isProductDetailsDisplayed(),"navigation error");
        Customer.checkoutItems();
        softAssert.assertFalse(Customer.isReviewOrderTextDisplayed(), "The user is unable to land on the Review Order page.");
        Customer.goToCatalog();
        softAssert.assertFalse(Customer.isUserNavigatedToCatalog(),"ERROR in navigating to catalog page");
