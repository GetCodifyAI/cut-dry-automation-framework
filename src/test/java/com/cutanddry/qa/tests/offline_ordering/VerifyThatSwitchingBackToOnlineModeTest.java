...
public class VerifyThatSwitchingBackToOnlineModeTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-1249")
    public void VerifyThatSwitchingBackToOnlineMode() throws InterruptedException {
