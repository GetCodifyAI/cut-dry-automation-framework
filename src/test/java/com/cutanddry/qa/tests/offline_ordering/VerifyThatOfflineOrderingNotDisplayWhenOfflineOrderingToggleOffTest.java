...
public class VerifyThatOfflineOrderingNotDisplayWhenOfflineOrderingToggleOffTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-1265")
    public void VerifyThatOfflineOrderingNotDisplayWhenOfflineOrderingToggleOff() throws InterruptedException {
        ...
        InternalTools.clickOfflineOrderingToggle(false);
