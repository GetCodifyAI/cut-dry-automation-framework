...
public class VerifyTheFilteringInvoicesByCustomerTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-878")
    public void VerifyTheFilteringInvoicesByCustomer() throws InterruptedException {
