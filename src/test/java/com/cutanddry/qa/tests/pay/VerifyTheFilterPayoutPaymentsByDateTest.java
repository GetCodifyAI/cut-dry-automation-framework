...
public class VerifyTheFilterPayoutPaymentsByDateTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-899")
    public void VerifyTheFilterPayoutPaymentsByDate() throws InterruptedException {
