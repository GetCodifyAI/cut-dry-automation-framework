...
public class VerifyTheInvoiceDisplayWithCorrectDataAndInvoiceActivityFlow extends TestBase{
    static User user;
    ...
    public void VerifyTheFilterInitiatedPaymentByStatusFunctionality() throws InterruptedException {
        ...
        String[] InvoiceInfoFromTable = Pay.getInvoiceInfoFromTable();

        Pay.clickFirstRowPayInit();
