...
public class VerifyTheInvoiceDisplayCorrectDataTest extends TestBase{
    static User user;
    ...
    @Test(groups = "DOT-TC-917")
    public void VerifyTheInvoiceDisplayCorrectData() throws InterruptedException {
        ...
        customerName=Pay.getCustomerNamePayment();
        Pay.clickOnePaymentInitiate();
        softAssert.assertTrue(Pay.isInvoiceDetailsDisplayed(customerName),"invoice display incorrect data");
