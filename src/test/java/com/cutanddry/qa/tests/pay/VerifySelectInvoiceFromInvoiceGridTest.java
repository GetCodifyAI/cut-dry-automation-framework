...
public class VerifySelectInvoiceFromInvoiceGridTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-890")
    public void VerifySelectInvoiceFromInvoiceGrid() throws InterruptedException {
