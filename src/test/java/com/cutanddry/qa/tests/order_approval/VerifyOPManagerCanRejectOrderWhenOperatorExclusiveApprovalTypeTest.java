...
public class VerifyOPManagerCanRejectOrderWhenOperatorExclusiveApprovalTypeTest {
    static User user;
    ...
    @Test(groups = "DOT-TC-3048")
    public void VerifyOPManagerCanRejectOrderWhenOperatorExclusiveApprovalType() throws InterruptedException {
