...
public class VerifyScrapperIntegratedEmployeeSubmitsOrderForGeneralApprovalTest {
    static User user;
    String DistributorName = "Independent Foods Co";
    String CustomerCode = "23445";
    String approvalType = "General Approval";
    ...
    @Test(groups = "DOT-TC-3137")
    public void VerifyScrapperIntegratedEmployeeSubmitsOrderForGeneralApproval() throws InterruptedException {
