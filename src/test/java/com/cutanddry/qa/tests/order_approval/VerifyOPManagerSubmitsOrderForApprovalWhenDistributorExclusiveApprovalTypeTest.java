...
public class VerifyOPManagerSubmitsOrderForApprovalWhenDistributorExclusiveApprovalTypeTest {
    static User user;
    ...
    @Test(groups = "DOT-TC-3022")
    public void VerifyOPManagerSubmitsOrderForApprovalWhenDistributorExclusiveApprovalType() throws InterruptedException {
