...
public class VerifyDpSalespersonUserCanApproveOrderWhenDistributorExclusiveApprovalTypeTest {
    static User user;
    ...
    @Test(groups = "DOT-TC-3024")
    public void VerifyDpSalespersonUserCanApproveOrderWhenDistributorExclusiveApprovalType() throws InterruptedException {
        ...
        softAssert.assertTrue(Catalog.isOrderStatusDisplay(orderId,status),"status not change to submitted");
