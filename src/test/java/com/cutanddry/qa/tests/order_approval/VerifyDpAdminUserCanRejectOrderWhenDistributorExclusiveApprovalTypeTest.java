...
public class VerifyDpAdminUserCanRejectOrderWhenDistributorExclusiveApprovalTypeTest {
    static User user;
    ...
    @Test(groups = "DOT-TC-3045")
    public void VerifyDpAdminUserCanRejectOrderWhenDistributorExclusiveApprovalType() throws InterruptedException {
