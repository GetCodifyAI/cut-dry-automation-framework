...
public class VerifyOPAdminSubmitsOrderForApprovalWhenDistributorExclusiveApprovalTypeTest {
    static User user;
    ...
    @Test(groups = "DOT-TC-3042")
    public void VerifyOPAdminSubmitsOrderForApprovalWhenDistributorExclusiveApprovalType() throws InterruptedException {
