...
public class VerifyDpAdminUserCanNotApproveOrderWhenOperatorExclusiveApprovalTypeTest {
    static User user;
    ...
    @Test(groups = "DOT-TC-3020")
    public void VerifyDpAdminUserCanNotApproveOrderWhenOperatorExclusiveApprovalType() throws InterruptedException {
        ...
        softAssert.assertTrue(Approvals.isDisableApproveAndSubmitBtnDisplayed(),"approve and submit button not disable");
