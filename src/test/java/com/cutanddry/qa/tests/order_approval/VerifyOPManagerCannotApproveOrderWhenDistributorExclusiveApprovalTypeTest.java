...
public class VerifyOPManagerCannotApproveOrderWhenDistributorExclusiveApprovalTypeTest {
    static User user;
    ...
    String ManagerUserCode ="133084368";
    ...
    @Test(groups = "DOT-TC-3023")
    public void VerifyOPManagerCannotApproveOrderWhenDistributorExclusiveApprovalType() throws InterruptedException {
        ...
        softAssert.assertFalse(Approvals.isApproveAndSubmitBtnDisplayed(),"approval and submit button display");
        softAssert.assertFalse(Approvals.isRejectApprovalsBtnDisplayed(),"reject button display");
