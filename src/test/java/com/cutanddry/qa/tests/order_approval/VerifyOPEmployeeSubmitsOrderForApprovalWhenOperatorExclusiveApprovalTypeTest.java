...
public class VerifyOPEmployeeSubmitsOrderForApprovalWhenOperatorExclusiveApprovalTypeTest {
    static User user;
    ...
    @Test(groups = "DOT-TC-3017")
    public void VerifyOPEmployeeSubmitsOrderForApprovalWhenOperatorExclusiveApprovalType() throws InterruptedException {
