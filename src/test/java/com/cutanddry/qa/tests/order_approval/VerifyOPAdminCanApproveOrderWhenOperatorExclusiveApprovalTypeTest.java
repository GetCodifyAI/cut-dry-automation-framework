...
public class VerifyOPAdminCanApproveOrderWhenOperatorExclusiveApprovalTypeTest {
    static User user;
    ...
    @Test(groups = "DOT-TC-3039")
    public void VerifyOPAdminCanApproveOrderWhenOperatorExclusiveApprovalType() throws InterruptedException {
