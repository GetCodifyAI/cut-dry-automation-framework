...
public class VerifyDpAdminUserCanApproveOrderWhenDistributorExclusiveApprovalTypeTest {
    static User user;
    ...
    @Test(groups = "DOT-TC-3025")
    public void VerifyDpAdminUserCanApproveOrderWhenDistributorExclusiveApprovalType() throws InterruptedException {
