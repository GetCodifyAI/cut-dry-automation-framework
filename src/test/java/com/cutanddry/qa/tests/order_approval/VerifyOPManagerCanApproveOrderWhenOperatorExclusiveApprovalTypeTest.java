...
public class VerifyOPManagerCanApproveOrderWhenOperatorExclusiveApprovalTypeTest {
    static User user;
    ...
    @Test(groups = "DOT-TC-3040")
    public void VerifyOPManagerCanApproveOrderWhenOperatorExclusiveApprovalType() throws InterruptedException {
        ...
        //Log in as Manager user to approve and submit the Order
