...
public class VerifyDeleteActivityAndRemoveUploadedFileTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-4414")
    public void VerifyDeleteActivityAndRemoveUploadedFile() throws InterruptedException {
        ...
        Customer.enterActivityDescription("This activity will be deleted");
        ...
        Customer.clickDeleteFirstActivity();
        Customer.confirmDeleteActivity();
        softAssert.assertTrue(Customer.isNoActivityYetDisplayed(), "Activity was not deleted - 'No activity yet' not displayed");
