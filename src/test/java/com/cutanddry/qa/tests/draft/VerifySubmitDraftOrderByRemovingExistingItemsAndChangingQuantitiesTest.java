...
public class VerifySubmitDraftOrderByRemovingExistingItemsAndChangingQuantitiesTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-772")
    public void VerifySubmitDraftOrderByRemovingExistingItemsAndChangingQuantities() throws InterruptedException {
