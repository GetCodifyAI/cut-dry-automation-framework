...
public class VerifyExemptFromOrderMinimumCustomerLevelOverrideTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-4502")
    public void VerifyExemptFromOrderMinimumCustomerLevelOverride() throws InterruptedException{
