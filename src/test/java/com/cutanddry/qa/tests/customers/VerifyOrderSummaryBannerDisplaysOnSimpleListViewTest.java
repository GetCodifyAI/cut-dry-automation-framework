...
public class VerifyOrderSummaryBannerDisplaysOnSimpleListViewTest extends TestBase {
    ...
    public void verifyOrderSummaryBannerDisplaysOnSimpleListView() throws InterruptedException {
        ...
        softAssert.assertTrue(Integer.parseInt(Customer.getItemQtyFirstRow()) > 0, "Product quantity not increased in Simple List View");
        ...
        softAssert.assertTrue(totalPrice > 0, "Order Summary total price should be greater than 0 after adding items");
