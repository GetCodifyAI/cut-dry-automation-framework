...
public class VerifyTheNavigationOfPreviewCatalogTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-654")
    public void VerifyTheNavigationOfPreviewCatalog() throws InterruptedException {
