...
public class VerifyUserCanPlaceOrderWithDecimalQuantityStandingOrderFlowTest extends TestBase {
    static User user;
    ...
    public void verifyUserCanPlaceOrderWithDecimalQuantityStandingOrderFlow() throws InterruptedException {
        ...
        softAssert.assertTrue(Customer.isOrderGuideTextDisplay(), 
            "Order guide not displayed for standing order");
        ...
        Customer.selectDeliveryDate("Monday");
        Customer.setStandingOrder();
        
        if (Customer.isStandingOrderEmailPopupDisplayed()) {
        ...
        softAssert.assertTrue(Customer.isStandingOrdersDisplayed(), 
            "Standing orders not displayed after creation");
