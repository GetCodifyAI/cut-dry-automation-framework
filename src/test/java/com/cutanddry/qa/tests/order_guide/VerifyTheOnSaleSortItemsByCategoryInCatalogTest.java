...
public class VerifyTheOnSaleSortItemsByCategoryInCatalogTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-1550")
    public void VerifyTheOnSaleSortItemsByCategoryInCatalog() throws InterruptedException {
