...
public class VerifyCreatingNormalOrderAndEditItFromPortalWhenDisableFetchPricesTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-1356")
    public void VerifyCreatingNormalOrderAndEditItFromPortalWhenDisableFetchPrices() throws InterruptedException {
        ...
        InternalTools.fetchPricesFromOrderForEditOrderFlowToggle(false);
