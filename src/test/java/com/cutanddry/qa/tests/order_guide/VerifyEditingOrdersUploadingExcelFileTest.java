...
public class VerifyEditingOrdersUploadingExcelFileTest extends TestBase {
    static User user;
    ...
    public void verifyEditingOrdersWithUploadingExcelFile() throws InterruptedException, URISyntaxException {
        ...
        softAssert.assertTrue(Customer.isOrderGuideUpdatedTextDisplayed(),"order guide updating error");
        Customer.clickOK();
