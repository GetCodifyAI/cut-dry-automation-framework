...
public class VerifyUserCanPlaceOrderWithDecimalQuantityEditOrderFlowTest extends TestBase {
    static User user;
    ...
    public void verifyUserCanPlaceOrderWithDecimalQuantityEditOrderFlow() throws InterruptedException {
        ...
        softAssert.assertTrue(Customer.isThankingForOrderPopupDisplayed(), 
            "Thank you popup not displayed - initial order submission failed");
        ...
        Thread.sleep(2000);
        softAssert.assertTrue(Customer.isOrderGuideTextDisplay(), 
            "Order guide not displayed after edit");
        ...
        Customer.setItemQtyFirstRow("2");
        Thread.sleep(1000);

        Customer.submitOrder();
        softAssert.assertTrue(Customer.isThankingForOrderPopupDisplayed(), 
            "Thank you popup not displayed - edited order submission failed");
        ...
        Customer.clickFirstOrderFrmOrderTab();
        softAssert.assertTrue(Customer.isOrderIdTxtDisplayed(), 
            "Edited order details not displayed");
