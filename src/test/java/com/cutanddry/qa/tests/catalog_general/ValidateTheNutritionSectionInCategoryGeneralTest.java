package com.cutanddry.qa.tests.catalog_general;
...
public class ValidateTheNutritionSectionInCategoryGeneralTest extends TestBase {
    static User user;
    String itemCode = "TOFL10";
    String itemCodeRevert = "08111";
    ...
    public void ValidateTheNutritionSectionInCategoryGeneral() throws InterruptedException {
        ...
        Dashboard.navigateToCatalog();
        softAssert.assertTrue(Catalog.isUserNavigatedToCatalog(),"navigation error");
        Catalog.selectItemFromGrid(itemCodeRevert);
        softAssert.assertEquals(Catalog.getItemcodeInCatalogData(),itemCodeRevert,"Error in getting Item Code");
