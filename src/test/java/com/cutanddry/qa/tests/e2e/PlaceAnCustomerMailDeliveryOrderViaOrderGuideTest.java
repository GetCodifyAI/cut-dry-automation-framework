...
public class PlaceAnCustomerMailDeliveryOrderViaOrderGuideTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-715")
    public void PlaceAnCustomerMailDeliveryOrderViaOrderGuide() throws InterruptedException {
