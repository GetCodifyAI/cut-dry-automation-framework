...
public class PlaceAnCustomerPickUpOrderViaPDPTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-717")
    public void PlaceAnCustomerPickUpOrderViaPDP() throws InterruptedException {
