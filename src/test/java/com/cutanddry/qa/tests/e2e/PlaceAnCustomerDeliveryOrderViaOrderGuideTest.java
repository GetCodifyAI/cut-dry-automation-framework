...
public class PlaceAnCustomerDeliveryOrderViaOrderGuideTest extends TestBase {
    ...
    public void placeCustomerDeliveryOrder() throws InterruptedException {
        softAssert = new SoftAssert();

        // Distributor Flow
        loginAsDistributor();
        navigateToCustomerOrderGuide();
        selectItemAndCheckout();
        submitOrder();
    ...
    private void selectItemAndCheckout() throws InterruptedException {
        ...
        softAssert.assertTrue(Customer.isDeliveryOptionSelected(), "Delivery option not selected.");
    }
