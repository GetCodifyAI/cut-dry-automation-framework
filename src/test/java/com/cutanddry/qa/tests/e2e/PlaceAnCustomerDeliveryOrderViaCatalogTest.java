...
public class PlaceAnCustomerDeliveryOrderViaCatalogTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-764")
    public void PlaceAnCustomerDeliveryOrderViaCatalog() throws InterruptedException {
