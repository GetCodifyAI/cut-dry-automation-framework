...
public class PlaceCustomerPickUpOrderViaOrderGuideCatalogPDPTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-725")
    public void PlaceCustomerPickUpOrderViaOrderGuideCatalogPDP() throws InterruptedException {
