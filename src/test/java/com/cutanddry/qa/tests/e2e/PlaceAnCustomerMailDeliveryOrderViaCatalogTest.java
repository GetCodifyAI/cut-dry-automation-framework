...
public class PlaceAnCustomerMailDeliveryOrderViaCatalogTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-766")
    public void PlaceAnCustomerMailDeliveryOrderViaCatalog() throws InterruptedException {
