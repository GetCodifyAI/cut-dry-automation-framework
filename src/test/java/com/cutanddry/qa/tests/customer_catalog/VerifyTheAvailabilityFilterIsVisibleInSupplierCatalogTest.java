...
public class VerifyTheAvailabilityFilterIsVisibleInSupplierCatalogTest extends TestBase {
    static User user;
    ...
    public void VerifyTheAvailabilityFilterIsVisibleInSupplierCatalog() throws InterruptedException {
