...
public class VerifyThatTheGPOFilterOptionInTheCustomerCatalogTest extends TestBase {
    static User user;
    ...
    String DistributorName ="169513310 - Thilini - Harbor Foodservice";
    ...
    @Test(groups = "DOT-TC-1494")
    public void VerifyThatTheGPOFilterOptionInTheCustomerCatalog() throws InterruptedException {
