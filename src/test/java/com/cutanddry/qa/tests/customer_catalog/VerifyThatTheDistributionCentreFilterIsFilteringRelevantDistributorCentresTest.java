...
public class VerifyThatTheDistributionCentreFilterIsFilteringRelevantDistributorCentresTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-1380")
    public void VerifyThatTheDistributionCentreFilterIsFilteringRelevantDistributorCentres() throws InterruptedException {
