...
public class SalesRepMappingAutomationAddNewUserWithAlternateERPUserReferenceTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-1259")
    public void SalesRepMappingAutomationAddNewUserWithAlternateERPUserReference() throws InterruptedException {
        ...
        Settings.enterAlternateERPUserRef(AlternateERPUserRef);
