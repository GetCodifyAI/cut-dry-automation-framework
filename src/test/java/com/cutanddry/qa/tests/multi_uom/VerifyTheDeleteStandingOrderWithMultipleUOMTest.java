...
public class VerifyTheDeleteStandingOrderWithMultipleUOMTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-786")
    public void VerifyTheDeleteStandingOrderWithMultipleUOM() throws InterruptedException {
