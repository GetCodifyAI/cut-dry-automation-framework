...
public class VerifyTheSelectMultipleUOMUsingAddFromCatalogTest extends TestBase {
    ...
    String itemName2 = CatalogData.ITEM_NAME_2;
    ...
    @Test(groups = "DOT-TC-1048")
    public void VerifyTheSelectMultipleUOMUsingAddFromCatalog() throws InterruptedException {
