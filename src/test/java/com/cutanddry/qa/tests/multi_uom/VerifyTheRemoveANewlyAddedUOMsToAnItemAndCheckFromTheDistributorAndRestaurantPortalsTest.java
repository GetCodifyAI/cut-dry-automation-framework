...
public class VerifyTheRemoveANewlyAddedUOMsToAnItemAndCheckFromTheDistributorAndRestaurantPortalsTest {
    static User user;
    ...
    @Test(groups = "DOT-TC-768")
    public void VerifyTheRemoveANewlyAddedUOMsToAnItemAndCheckFromTheDistributorAndRestaurantPortals() throws InterruptedException {
