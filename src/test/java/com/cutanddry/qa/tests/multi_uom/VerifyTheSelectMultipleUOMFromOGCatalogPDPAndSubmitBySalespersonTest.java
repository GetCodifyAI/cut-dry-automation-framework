...
public class VerifyTheSelectMultipleUOMFromOGCatalogPDPAndSubmitBySalespersonTest extends TestBase {
    ...
    static String salesPersonRoll =CatalogData.SALE_PERSON_ROLL;
    ...
    @Test(groups = "DOT-TC-1012")
    public void VerifyTheSelectMultipleUOMFromOGCatalogPDPAndSubmitBySalesperson() throws InterruptedException {

        softAssert = new SoftAssert();

        Login.logIntoRestaurant(user.getEmailOrMobile(), user.getPassword());
        Assert.assertTrue(Dashboard.isUserNavigatedToRestaurantDashboard(),"login error");
        Login.navigateToLoginAsPortal(salesPersonRoll);
        ...
        softAssert.assertEquals(Catalog.getItemUOMQuantity(searchItemCode, uom1), "1", "item count error in 1st UOM");
        softAssert.assertEquals(Catalog.getItemUOMQuantity(searchItemCode, uom2), "1", "item count error in 2nd UOM");
