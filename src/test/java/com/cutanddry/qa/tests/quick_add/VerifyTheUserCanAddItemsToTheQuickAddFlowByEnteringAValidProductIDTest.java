...
public class VerifyTheUserCanAddItemsToTheQuickAddFlowByEnteringAValidProductIDTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-1528")
    public void VerifyTheUserCanAddItemsToTheQuickAddFlowByEnteringAValidProductID() throws InterruptedException {
