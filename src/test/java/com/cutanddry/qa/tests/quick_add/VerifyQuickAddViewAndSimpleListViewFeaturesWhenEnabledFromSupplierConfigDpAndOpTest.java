...
public class VerifyQuickAddViewAndSimpleListViewFeaturesWhenEnabledFromSupplierConfigDpAndOpTest extends TestBase {
    ...
    @Test(groups = "DOT-TC-1562")
    public void VerifyQuickAddViewAndSimpleListViewFeaturesWhenEnabledFromSupplierConfigDpAndOp() throws InterruptedException {
