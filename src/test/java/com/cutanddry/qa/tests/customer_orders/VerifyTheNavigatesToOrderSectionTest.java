...
public class VerifyTheNavigatesToOrderSectionTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-670")
    public void VerifyTheNavigatesToOrderSection() throws InterruptedException {
