...
public class VerifyThePrintOrderConfirmationTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-668")
    public void VerifyThePrintOrderConfirmation() throws InterruptedException {
        ...
        Customer.clickOrderConfirmation();
