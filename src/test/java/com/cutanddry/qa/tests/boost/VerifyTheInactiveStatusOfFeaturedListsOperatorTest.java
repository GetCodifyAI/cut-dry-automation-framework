...
public class VerifyTheInactiveStatusOfFeaturedListsOperatorTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-4508")
    public void VerifyTheInactiveStatusOfFeaturedListsOperator() throws InterruptedException {
