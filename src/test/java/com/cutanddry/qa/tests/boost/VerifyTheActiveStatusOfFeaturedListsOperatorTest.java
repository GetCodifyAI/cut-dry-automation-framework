...
public class VerifyTheActiveStatusOfFeaturedListsOperatorTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-4510")
    public void VerifyTheActiveStatusOfFeaturedListsOperator() throws InterruptedException {
