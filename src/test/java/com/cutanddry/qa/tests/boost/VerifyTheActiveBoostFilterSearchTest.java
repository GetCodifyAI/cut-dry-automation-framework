...
public class VerifyTheActiveBoostFilterSearchTest extends TestBase {
    ...
    public void VerifyTheActiveBoostFilterSearch() throws InterruptedException {
        ...
        Boost.TurnOnBoostFilterSearchToggle(StockedInHouse, true);
        Boost.TurnOnBoostFilterSearchToggle(inStock, true);
        Boost.TurnOnBoostFilterSearchToggle(manufacturerRebates, true);
        ...
        softAssert.assertTrue(Customer.isCatalogSelectedFilterOptionDisplayed(StockedInHouse), "filter display error StockedInHouse");

        Customer.clickCatalogFilterDropDown(availability);
        softAssert.assertTrue(Customer.isCatalogSelectedFilterOptionDisplayed(inStock), "filter display error InStock");

        Customer.clickCatalogFilterDropDown(deals);
        softAssert.assertTrue(Customer.isCatalogSelectedFilterOptionDisplayed(manufacturerRebates), "filter display error ManufacturerRebates");
