...
public class VerifyForceShowModalForMutualSubstituteProductsTest extends TestBase{
    static User user;
    ...
    @Test(groups = "DOT-TC-1585")
    public void VerifyForceShowModalForMutualSubstituteProducts() throws InterruptedException {
        ...
        InternalTools.TurnOnForceShowSubstitutesEnabledToggle(true);
        InternalTools.TurnOnShowSubstitutesModalInPortalEnabledToggle(true);
        ...
        Customer.searchItemOnCatalog(searchItemCode1);
        Customer.clickOnPlusIconInCatalog(1, searchItemCodeName1);
        Customer.checkoutSubstituteItems();
        softAssert.assertTrue(Customer.isSubstitutesPopupDisplayed(),"substitutes popup error");
        softAssert.assertTrue(Customer.isAddedSubstitutesItemDisplayed(substituteItemName1),"substitutes item display error");
