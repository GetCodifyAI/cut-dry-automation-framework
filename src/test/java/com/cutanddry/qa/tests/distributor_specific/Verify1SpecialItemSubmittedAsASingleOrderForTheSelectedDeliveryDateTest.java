...
public class Verify1SpecialItemSubmittedAsASingleOrderForTheSelectedDeliveryDateTest extends TestBase {
    static User user;
    ...
    @Test(groups = "DOT-TC-595")
    public void Verify1SpecialItemSubmittedAsASingleOrderForTheSelectedDeliveryDate() throws InterruptedException {
