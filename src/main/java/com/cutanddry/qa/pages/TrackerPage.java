...
public class TrackerPage extends LoginPage{
    ...
    By btn_issue_tracker = By.xpath("//a[@data-rb-event-key='Issue Tracker' and text()='Issue Tracker']");
    ...
    By btn_feature_requests = By.xpath("//a[@data-rb-event-key='Feature Requests' and text()='Feature Requests']");
