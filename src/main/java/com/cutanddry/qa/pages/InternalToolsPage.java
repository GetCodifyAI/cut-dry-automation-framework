...
public class InternalToolsPage extends LoginPage {
    ...
    By AllowSupplierToSetMinimumToggleStable = By.xpath("//div[contains(text(), 'Customer Specific Order Minimums')]/following-sibling::div//div[@class='react-switch-bg']/following-sibling::div[@class='react-switch-handle']");
    By AllowSupplierToSetMinimumToggleStable1 = By.xpath("//div[contains(text(), 'Customer Specific Order Minimums')]/following-sibling::div//div[@class='react-switch-bg']/following-sibling::div[@class='react-switch-handle']/parent::div/div[1]");
