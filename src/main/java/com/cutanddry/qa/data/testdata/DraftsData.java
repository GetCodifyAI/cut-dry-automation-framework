...
public class DraftsData {
    ...
    public static final String SUPPLIER_NAME = "Independent Foods Co";
    public static final String RESTAURANT_USER_CODE = "103430764";
    public static final String DRAFT_CONFIRMATION = "Deleting it will remove it permanently, and it cannot be restored.";
