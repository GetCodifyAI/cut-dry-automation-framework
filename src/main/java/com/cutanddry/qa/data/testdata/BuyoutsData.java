...
public class BuyoutsData {
    public static final String BUYOUT_NOT_ALLOWED_CUSTOMER = "20240336";
    ...
    public static final String BUYOUT_PRODUCT_ITEMCODE = "296013";
    public static final String BUYOUT_PRODUCT_ITEMCODE2 = "343831";
    public static final String BUYOUT_PRODUCT1_CANONICAL_NODE = "125770706";
    public static final String BUYOUT_PRODUCT2_CANONICAL_NODE = "551181203";
    public static final String BUYOUT_PRODUCT_ITEMNAME = "Almond Butter Roasted No Salt Added";
    public static final String BUYOUT_PRODUCT_ITEMNAME2 = "App Beef Wellington";
    ...
    public static final String ITEM_UOM2 = "Each";
    public static final String ORDER_MINIMUM_LABEL = "Order Minimum ($)";
